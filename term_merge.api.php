 ...
 *   Fully loaded taxonomy term object of the term trunk
 * @param object $term_branch
 *   Fully loaded taxonomy term object of the term branch
 * @param array $context
...
function hook_term_merge($term_trunk, $term_branch, $context) {
  ...
  // UPDATE {my_table}
  //   SET term_tid = $term_branch->tid
  //   WHERE term_tid = $term_trunk->tid
